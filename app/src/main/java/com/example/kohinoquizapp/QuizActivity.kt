...
import com.example.kohinoquizapp.databinding.ActivityQuizBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        quizBinding.textViewA.setOnClickListener {
            ...
            if(correctAnswer == userAnswer){
                ...
                userWrong++
                quizBinding.textViewWrong.text=userCorrect.toString()
                findAnswer()
            }
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                questionCount = snapshot.childrenCount.toInt()
                    ...
                    if (questionNumber <= questionCount) {
                        ...
                        answerD =
                            snapshot.child(questionNumber.toString()).child("Id").value.toString()
                        ...
                        dialogMessage.setTitle("Quiz Gane")
